...
describe('Requisito 6', () => {
  test('Verifica se as informações corretas do primeiro pokemon aparecem na tela', () => {
  ...
  test('Verifica se as informações corretas do segundo pokemon aparecem na tela', () => {
    renderWithRouter(<App />);
  ...
  test('Verifica se na pokedex existe um link de mais informações do pokemon', () => {
    renderWithRouter(<App />);
  ...
  test('Verifica se a página de mais informações possuem o url correta', () => {
  ...
  test('Verifica se os pokemons favoritados possuem o icone de favorito', () => {
    renderWithRouter(<App />);
